...
const groups = [
  {
    ...
    items: [
      ...
      { label: 'Users & roles', path: '/admin/users', icon: <svg viewBox="0 0 24 24"><circle cx="9" cy="8" r="3"></circle><path d="M2 21v-1a7 7 0 0 1 14 0v1"></path><circle cx="17" cy="9" r="2.5"></circle><path d="M14.5 21v-1a5.5 5.5 0 0 1 7 0v1"></path></svg>, roles: ['ADMIN'] },
      { label: 'System control', path: '/admin/system-control', icon: <svg viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="6" rx="2"></rect><rect x="3" y="14" width="18" height="6" rx="2"></rect><circle cx="8" cy="7" r="1"></circle><circle cx="16" cy="17" r="1"></circle><path d="M11 7h6"></path><path d="M3 17h10"></path></svg>, roles: ['ADMIN'] },
      { label: 'Trip governance', path: '/admin/trip-governance', icon: <svg viewBox="0 0 24 24"><path d="M5 5h14v14H5z"></path><path d="M9 9h6"></path><path d="M9 13h6"></path><path d="M9 17h4"></path><circle cx="17" cy="7" r="2"></circle></svg>, roles: ['ADMIN'] },
      { label: 'Fleet master data', path: '/admin/fleet-master-data', icon: <svg viewBox="0 0 24 24"><path d="M4 6h16"></path><path d="M4 12h16"></path><path d="M4 18h16"></path><circle cx="8" cy="6" r="2"></circle><circle cx="16" cy="12" r="2"></circle><circle cx="10" cy="18" r="2"></circle></svg>, roles: ['ADMIN'] },
      { label: 'Admin Analytics', path: '/admin/analytics', icon: <svg viewBox="0 0 24 24"><path d="M4 19h16"></path><path d="M7 15v-5"></path><path d="M12 15V7"></path><path d="M17 15v-9"></path></svg>, roles: ['ADMIN'] },
      { label: 'Analytics', path: '/analytics/reports', icon: <svg viewBox="0 0 24 24"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg>, roles: ['OPERATIONS_MANAGER', 'DISPATCHER', 'PLANNER', 'MAINTENANCE_MANAGER'] },
      { label: 'Performance', path: '/driver/performance', icon: <svg viewBox="0 0 24 24"><path d="M4 19h16"></path><path d="M7 16l4-6 3 3 3-5"></path><circle cx="7" cy="16" r="1"></circle><circle cx="11" cy="10" r="1"></circle><circle cx="14" cy="13" r="1"></circle><circle cx="17" cy="8" r="1"></circle></svg>, roles: ['DRIVER'] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Trips', path: '/trips', icon: <svg viewBox="0 0 24 24"><path d="M22 12h-4l-3 9L9 3l-3 9H2"></path></svg>, roles: ['ADMIN', 'OPERATIONS_MANAGER', 'DISPATCHER', 'MAINTENANCE_MANAGER'] },
      { label: 'Trip Execution', path: '/driver/trip-execution', icon: <svg viewBox="0 0 24 24"><polygon points="3 11 22 2 13 21 11 13 3 11"></polygon></svg>, roles: ['DRIVER'] },
